        ...
        <div className="grid md:grid-cols-2 gap-8 items-center justify-center place-items-center my-auto z-10 h-full">
          ...
          >
            ...
            <div className='flex flex-wrap gap-6 mt-6 justify-center lg:justify-start'>
              ...
              <a href='https://drive.google.com/file/d/14LM1Y0pjnwP4M7wtdOqUTa1Mh_p8JO1t/view?usp=drive_link' className="bg-[#181a1b] text-white py-2.5 px-4 text-xs lg:text-sm items-center text-center justify-center rounded-lg shadow-sm border border-white transition-colors duration-300" download target='_blank' rel='noreferrer'>Download CV</a>
              <a
